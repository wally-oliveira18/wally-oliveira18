...
- [Análise Explanatória de Fraudes de cartões](https://github.com/wally-oliveira18/Analise-explanatoria-de-fraudes): (Em desenvolvimento) Análise explatória dos dados envolvendo frades de cartões. A análise foi feita utilizando comando básicos utilizando a ferramenta MySQL Workbench. 
